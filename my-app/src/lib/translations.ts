...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    herePhorosOfArm: "Here are photos of my robotic arm. Please analyze them and help me figure out how to control it.",
  ...
  es: {
    ...
    herePhorosOfArm: "Aquí hay fotos de mi brazo robótico. Por favor, analízalas y ayúdame a descubrir cómo controlarlo.",
  ...
  fr: {
    ...
    herePhorosOfArm: "Voici des photos de mon bras robotique. Veuillez les analyser et m'aider à comprendre comment le contrôler.",
  ...
  zh: {
    ...
    herePhotosOfArm: "这是我的机械臂的照片。请分析它们并帮助我了解如何控制它。",
